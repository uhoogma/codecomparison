...
ALTER TABLE ABSTRACTEDCODE DROP FOREIGN KEY FK_abstractedcode_attempt;
...
ALTER TABLE STUDENT DROP INDEX (moodleId);
ALTER TABLE SAVEDCOMPARISON DROP INDEX (firstAttemptId);
ALTER TABLE SAVEDCOMPARISON DROP INDEX (secondAttemptId);
