...
public class RemoveExpressionStatements extends Java8BaseListener {
	 ...
	 * important roles in both the source code and the execution of the program.
	 * However, our abstractor eliminates all of the normal expression
	 ...
	 * statement does a little work but a sequence of statements are composed to
	 * perform a significant work. For an individual statement, there may be
	 * several alternative statements. For example, addition statement of a
	 ...
	 * Our abstraction completely eliminates expression statements from regular
	 * statements, but the argument expressions of the function calls left in
	 * the abstract code remain as they are.
	 */
