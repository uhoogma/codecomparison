...
public class RemoveUserDefinedNames extends Java8BaseListener {
	...
	public RemoveUserDefinedNames(TokenStreamRewriter rewriter, List<String> declaredFunctions,
	...
	public void enterMethodInvocation(@NotNull Java8Parser.MethodInvocationContext ctx) {
		...
		if (id != null && pt != null && declaredFunctions.contains(id.getText())) { // methodName
																					// is
																					// at
																					// the
																					// first
	...
	public void enterMethodName(@NotNull Java8Parser.MethodNameContext ctx) {
		TerminalNode id = ctx.Identifier();
		if (insideMethodInvocation && id != null && declaredFunctions.contains(id.getText())) { // 2nd
																								// level
